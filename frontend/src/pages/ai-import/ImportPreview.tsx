...
const ImportPreview: React.FC<ImportPreviewProps> = ({ previewData, onCancel, onSuccess }) => {
  const { token } = useAuth();
  ...
  return (
    <div className="space-y-8 text-white">
      ...
      {/* Main Review Section split into Data Grid & Duplicate Panel */}
      <div className="grid gap-8 lg:grid-cols-3">
        ...
        {/* Duplicate & Validation Warnings Panel */}
        <div className="space-y-6 lg:col-span-1">
          ...
          <div className="rounded-3xl border border-white/5 bg-slate-950/60 p-6 shadow-2xl backdrop-blur-xl">
            <h3 className="text-md font-bold mb-4 flex items-center gap-2">
              ...
              Duplicate Warnings ({previewData.duplicates.length})
            </h3>
